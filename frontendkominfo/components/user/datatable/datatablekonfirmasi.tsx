...
const Datatablekonfirmasi = ({itemsEmail, itemsUserid}) =>{
  ...
  async function onSubmit(values){
    ...
    try {
      getKonfirmasi(values.searchticket); 
    } catch(err){
      console.log(err)
    }
  } 

  async function getKonfirmasi(searchDash){
    const api = `${process.env.NEXT_PUBLIC_API_SITE}/api/ticket?user_id=${tknemail.userid}&search=${searchDash}`
...
export default Datatablekonfirmasi;