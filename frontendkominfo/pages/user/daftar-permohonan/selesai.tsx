...
import SelesaiTable from '../../../components/user/datatable/datatableselesai'
...
const PermohonanSelesai = ({email, iduser}) => {
  ...
  function pullData(){
    document.querySelector('#permohonan-selesai').classList.add('active')
    ...
    <Header itemsEmail={tknuser.emailuser} itemsUserid={tknuser.iduseruser} />
      <Sidebar itemsEmail={tknuser.emailuser} itemsUserid={tknuser.iduseruser} />
        ...
        <div className="bg-light p-lg-4 p-md-4 p-3">
          <h5 className="float-md-start float-lg-start"><strong>Permohonan Selesai</strong></h5>
          <small className="float-md-end float-lg-end"><Link href={`/user/dashboard`} className="text-primary">Dashboard /</Link> <Link href="#" className="text-primary">Permohonan / </Link>Selesai</small>
          <div className="clearfix" />
        </div>
        <br />
        <SelesaiTable itemsEmail={tknuser.emailuser} itemsUserid={tknuser.iduseruser} />
        </div>
      <Footer />
      <Boots />
    </div>
